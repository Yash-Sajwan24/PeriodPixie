...
function TrackPeriod() {
	...
	const generatePDF = () => {
		...
		doc.html(document.querySelector("#Results"), {
			callback: function (pdf) {
				pdf.save("Period-Pixie_Tracker_Results.pdf");
			},
		});
	...
	return (
		<>
			...
			>
				{/* <h1>Period's Tracker</h1> */}
				<Box>
					{!doReveal && (
						<Grid
							container
							className="tracker-inner"
						>
					...
					{doReveal ? (
						<Box mt={10}>
								...
								<Grid item xs={12} style={{ textAlign: "center" }}>
									...
									>
										<Button
											...
											href="/track"
											className="track-button"
											style={{ color: "white", fontWeight: "500",borderRadius:"20px" }}
										>
											Back
										</Button>
										<Typography variant="h5" style={{ backgroundColor: "white",borderRadius:"25px",paddingRight:"39px",paddingLeft:"39px",paddingTop:"3px" }}>
							...
							<Grid container>
								<Grid item xs={12} style={{ textAlign: "center" }}>
									<Box mt={5}>
										<Typography variant="subtitle1" style={{color:"white", backgroundColor: "black", width:"50%", marginLeft:"25%",borderRadius:"20px"}}>
